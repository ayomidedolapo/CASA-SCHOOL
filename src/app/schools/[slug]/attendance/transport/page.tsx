    ...
    <main className="casa-noise min-h-screen bg-[#f2f2ef] text-[#0b0b0a]">
      <header className="border-b border-black/15">
        <div className="mx-auto grid w-full max-w-[1700px] lg:grid-cols-[0.72fr_1.28fr]">
          <section className="border-b border-black/15 px-6 py-6 lg:border-b-0 lg:border-r lg:px-12 lg:py-9">
            ...
            <p className="casa-kicker mt-14 text-black/40">
              Transport &amp; grace
            </p>
          ...
          <section className="flex flex-col justify-between bg-white px-6 py-6 lg:px-12 lg:py-9">
            ...
            <div className="mt-12">
              ...
              <p className="mt-4 max-w-xl text-sm leading-6 text-black/50">
                {visibility.access.school.name}. Configure explicit windows for the campus in your operating scope and effective-dated student transport assignments.
              </p>
            </div>
          </section>
        </div>
