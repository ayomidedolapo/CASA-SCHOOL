...
Write-Host "CASA School - Current HEAD 1710b4f Transition Truth Probe V1" -ForegroundColor Green
...
try {
    ...
    $Evidence =
        Join-Path `
            $ProjectRoot `
            ".casa-backups\head-1710b4f-transition-truth-v1-$Stamp"
    ...
    Write-Host ""
    Write-Host "CASA CURRENT HEAD 1710b4f TRANSITION TRUTH PROBE V1 IS GREEN" -ForegroundColor Green
    Write-Host "  branch/head:                     $Branch/$Head"
    ...
    Write-Host ""
    Write-Host "CASA CURRENT HEAD 1710b4f TRANSITION TRUTH PROBE V1 STOPPED: $($_.Exception.Message)" -ForegroundColor Red
    throw
}
