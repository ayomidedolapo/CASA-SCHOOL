...
try {
  Write-Host "CASA School - Permanent Card + Scanner Simplification V1R2" -ForegroundColor Green
  ...
  $Evidence = Join-Path $ProjectRoot ".casa-backups\permanent-card-scanner-simplification-v1r2-$stamp"
...
'@
  ...
  Write-Host ""
  Write-Host "CASA PERMANENT CARD + SCANNER SIMPLIFICATION V1R2 IS GREEN" -ForegroundColor Green
