...
try {
  Write-Host "CASA School - Permanent Card + Scanner Simplification V1R6" -ForegroundColor Green
  ...
  $Evidence = Join-Path $ProjectRoot ".casa-backups\permanent-card-scanner-simplification-v1r6-$stamp"
  ...
  $PatcherPath = Join-Path $Evidence "apply-permanent-card-scanner-v1r6.mjs"
  $patcher = @'
...
'@
  ...
  Write-Host ""
  Write-Host "CASA PERMANENT CARD + SCANNER SIMPLIFICATION V1R6 IS GREEN" -ForegroundColor Green
