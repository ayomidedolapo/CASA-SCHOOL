...
try {
    Write-Host "CASA School - Scanner AWS Credential Chain Recovery V1R2" -ForegroundColor Green
    ...
    Write-Host "V1R2 moves the streaming-role proof to the Node AWS SDK to avoid Windows native-CLI inline JSON quoting."
...
'@
    ...
    $result = [ordered]@{
        ...
        proof = "CASA_SCANNER_AWS_CREDENTIAL_CHAIN_RECOVERY_V1R2"
    ...
    Write-Host ""
    Write-Host "CASA SCANNER AWS CREDENTIAL CHAIN RECOVERY V1R2 IS GREEN" -ForegroundColor Green
