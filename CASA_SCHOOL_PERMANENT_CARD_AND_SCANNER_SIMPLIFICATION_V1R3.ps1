...
try {
  Write-Host "CASA School - Permanent Card + Scanner Simplification V1R3" -ForegroundColor Green
  ...
  $Evidence = Join-Path $ProjectRoot ".casa-backups\permanent-card-scanner-simplification-v1r3-$stamp"
...
'@
  ...
  Write-Host ""
  Write-Host "CASA PERMANENT CARD + SCANNER SIMPLIFICATION V1R3 IS GREEN" -ForegroundColor Green
