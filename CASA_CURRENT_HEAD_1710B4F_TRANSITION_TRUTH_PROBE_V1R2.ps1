...
$Pins = [ordered]@{
    ...
    "scripts\pass-a-selftest.ts" = "ce24cd2c31dae5c23c2bed86a83ea68a8b5b6525bd8b8d4c5eb5c13b88d55bd4"
...
Write-Host "CASA School - Current HEAD 1710b4f Transition Truth Probe V1R2" -ForegroundColor Green
...
try {
    ...
    $Evidence =
        Join-Path `
            $ProjectRoot `
            ".casa-backups\head-1710b4f-transition-truth-v1r2-$Stamp"
    ...
    Write-Host ""
    Write-Host "CASA CURRENT HEAD 1710b4f TRANSITION TRUTH PROBE V1R2 IS GREEN" -ForegroundColor Green
    Write-Host "  branch/head:                     $Branch/$Head"
    ...
    Write-Host ""
    Write-Host "CASA CURRENT HEAD 1710b4f TRANSITION TRUTH PROBE V1R2 STOPPED: $($_.Exception.Message)" -ForegroundColor Red
    throw
}
