...
try {
    Write-Host "CASA School - Scanner AWS Credential Chain Recovery V1R1" -ForegroundColor Green
    ...
    $EvidenceRoot = Join-Path $ProjectRoot ".casa-backups\scanner-aws-credential-chain-recovery-v1r1-$stamp"
...
'@
    ...
    $result = [ordered]@{
        ...
        proof = "CASA_SCANNER_AWS_CREDENTIAL_CHAIN_RECOVERY_V1R1"
    ...
    Write-Host ""
    Write-Host "CASA SCANNER AWS CREDENTIAL CHAIN RECOVERY V1R1 IS GREEN" -ForegroundColor Green
